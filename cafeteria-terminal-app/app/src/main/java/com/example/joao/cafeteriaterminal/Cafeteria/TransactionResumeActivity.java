...
public class TransactionResumeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        transaction_curr_value.setText(Html.fromHtml("<font color='#3F51B5'>Previously Value: </font>" + transaction.getTransactionTotalPrice()), TextView.BufferType.SPANNABLE);
